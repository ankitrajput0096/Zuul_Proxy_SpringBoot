...
public class simpleControllerTwo {
    ...
    public ResponseEntity<String> controllerClientOneEndpointOne() {
        return ResponseEntity.ok().body("This is hello endpoint one from controller two in client One");
    }
    ...
    public ResponseEntity<String> controllerClientOneEndpointTwo() {
        return ResponseEntity.ok().body("This is hello endpoint two from controller two in client One");
    }
}